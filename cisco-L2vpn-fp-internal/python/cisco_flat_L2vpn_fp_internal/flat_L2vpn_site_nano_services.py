...
class FlatL2vpnValidator(object):
    ...
    def cb_validate(self, tctx, kp, newval):
        return TsdnUtils.validate_service(self, Utils.site_validation_callpoint, tctx, kp)
...
class FlatL2vpnCallBack(FlatL2vpnServices):
    ...
    def cb_pre_modification(self, tctx, op, kp, root, proplist):
        return self.l2vpn_pre_modification(constants.SITE, tctx, op, kp, root, proplist)
    ...
    def cb_post_modification(self, tctx, op, kp, root, proplist):
        ...
        if (op == _ncs.dp.NCS_SERVICE_CREATE) or (op == _ncs.dp.NCS_SERVICE_UPDATE):
            ...
            plan_path = ("/cisco-flat-L2vpn-fp-internal-site:flat-L2vpn-internal-site"
                         f"/flat-L2vpn-plan{{{service.name} \"{service.site_name}\"}}")
